        ...
        <div className="relative wrap">
          ...
          <ul className="space-y-5 max-w-2xl">
            {[
              ...
              "This form is a request to have a member of our team contact you about scheduling. A small fee may apply. All requests are subject to station and crew availability.",
            ].map((text) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 pt-16">
            ...
            <aside>
              <div className="sticky top-28 bg-[#071428] border border-white/8 rounded-2xl p-6">
                ...
                <h3 className="text-white font-black text-sm uppercase tracking-widest mb-4">About This Experience</h3>
                <ul className="space-y-3 mb-6">
                  {[
                    "Host your child's party right at the Millstadt EMS station",
                    "Kids explore the ambulance and meet the crew",
                    "A small fee may apply for this event",
                    "Subject to station and crew availability",
                    "A team member will contact you to confirm scheduling",
                  ].map(r => (
            ...
            <div className="lg:col-span-2">
              ...
              >
                ...
                <div className="p-10 rounded-2xl bg-[#071428] border border-white/8 space-y-10">
                  ...
                  <div>
                    <label className={labelClass}>Approx. Number of Guests</label>
                    <input type="number" name="num_guests" min="1" className={inputClass} placeholder="e.g. 20" />
                  </div>
                  <div>
