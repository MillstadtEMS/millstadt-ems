          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 w-full max-w-4xl">
            {[
              ...
              <Link
                key={card.label}
                href={card.href}
                className="group flex flex-col items-center text-center gap-10 pt-32 pb-12 px-10 rounded-2xl bg-[#071428] border border-white/8 hover:bg-[#0c1e3d] hover:border-[#f0b429]/50 transition-all duration-200 cursor-pointer"
              >
