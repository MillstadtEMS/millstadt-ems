...
const ALLOWED_REPORT_KEYS = [
  ...
  "contactAcknowledgmentAccepted",
  "certificationText",
  "contactAcknowledgmentText",
  "signatureMethod",
  "signatureDataUrl",
  "signatureTypedName",
  "supportingDocument",
    ...
    const result = await createAccuracyReport(
      {
        ...
        contactAcknowledgmentAccepted: data.get("contactAcknowledgmentAccepted"),
        certificationText: data.get("certificationText"),
        contactAcknowledgmentText: data.get("contactAcknowledgmentText"),
