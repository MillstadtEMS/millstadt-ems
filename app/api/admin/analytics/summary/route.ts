...
export async function GET(req: NextRequest) {
  ...
  const workflowData = financialWorkflowAnalytics(range.from, range.to);
  summary.workflow = workflowData.workflow;

  return noStoreJson({
    summary,
    identifiedWorkflows: workflowData.identifiedWorkflows,
