  ...
  return (
    <div style={pageStyle}>
      <div style={{ maxWidth: 880, margin: "0 auto" }}>
        ...
        <h1 style={titleStyle}>My Certifications</h1>
        <p style={{ color: "#94a3b8", fontSize: "0.92rem", marginTop: 6, maxWidth: 560 }}>
          Upload a copy of each cert you carry. The system tracks expirations
          for the ones that require renewal and reminds you starting 120 days
          out.
        </p>
