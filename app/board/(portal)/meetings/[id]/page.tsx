  ...
  return (
    <>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, margin: "14px 0 6px", flexWrap: "wrap" }}>
        ...
        <span style={{ fontFamily: "var(--b-mono)", fontSize: 10.5, letterSpacing: ".05em", color: "var(--b-muted)", textTransform: "uppercase" }}>{meeting.type} meeting</span>
      ...
      {!meeting.detailsConfirmed && <p className="board-chip review" style={{ display: "inline-flex", marginTop: 10 }}>Time &amp; location are generated defaults — an admin should confirm them</p>}
      ...
      <div className="board-card">
        <div style={{ display: "flex", alignItems: "baseline", gap: 12, flexWrap: "wrap" }}>
          <span style={{ fontFamily: "var(--b-serif)", fontSize: 24, fontWeight: 700, color: qColor }}>{q.status}</span>
        ...
        {isDefault && <p className="board-chip review" style={{ display: "inline-flex", marginTop: 14 }}>Quorum = simple majority (default) — Needs Review by Kenneth James to set the bylaw figure</p>}
      </div>
        ...
        {visibleQuestions.map((question) => (
          <div key={question.id} className="board-card">
            <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", marginBottom: 6 }}>
              <span style={{ fontFamily: "var(--b-mono)", fontSize: 10.5, letterSpacing: ".05em", textTransform: "uppercase", color: "var(--b-accent)" }}>{question.category}</span>
              ...
              {question.afterDeadline && <span className="board-chip">After deadline</span>}
