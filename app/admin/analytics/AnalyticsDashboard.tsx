...
export default function AnalyticsDashboard() {
  ...
  const [exportFields, setExportFields] = useState<string[]>(["overview", "topPages"]);
  ...
  const { summary, configuration } = data;
    ...
    <div className={styles.page}>
      <header className={styles.header}>
        <div>
          ...
          <p>Aggregate and pseudonymous website measurements with protected security review tools.</p>
        </div>
      ...
      <div className={styles.grid}>
        ...
        <Panel title="Protected aggregate export" wide>
          <p className={styles.panelText}>Choose only the aggregate fields needed. Raw security identifiers are excluded.</p>
