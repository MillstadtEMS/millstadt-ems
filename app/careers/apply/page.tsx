...
export default function ApplyPage() {
  return (
    <>
      {/* Page Header */}
      <section className="relative pt-8 sm:pt-12 pb-8 sm:pb-12 bg-[#040d1a] overflow-hidden">
        ...
        <div className="relative wrap">
          ...
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-black text-white leading-tight mb-3 sm:mb-4">
