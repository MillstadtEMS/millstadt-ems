...
export const KIDS_ACTIVITIES: KidsActivity[] = [
  ...
  },
  {
    ...
    learn: "EMS crews use protective gear, monitors, oxygen supplies, and stretchers for specific patient-care jobs.",
    helpLevel: "Side-by-side",
    time: "25 min",
    supplies: ["Tool cards", "Pencil", "Ambulance picture"],
    steps: [
      "Look at photos or cards of common EMS tools.",
      "Match each picture to its purpose in simple words.",
      "Talk about why crews wear gloves and keep equipment clean.",
      "Complete an explorer checklist and choose a badge to color.",
    ],
    safetyNote: "Kids should look, ask questions, and leave all real EMS equipment to trained responders.",
