export const ACCURACY_REPORT_VERSION = "DEV-ACCURACY-2026.08.16";
...
export const ACCURACY_REPORT_INTRO = [
  ...
  "This form is for internal review. It is not an emergency-reporting channel, public-records request process, legal-service process, or guarantee that Millstadt will remove, change, or republish material.",
];

export const ACCURACY_IDENTITY_HELP =
  "This form requires identifying information so Millstadt can follow up, discourage fabricated submissions, and maintain an administrative review record. Your information will not be displayed publicly. This requirement applies only to this voluntary reporting form and does not state that anonymous communication is unlawful.";
...
export const ACCURACY_CONTACT_ACKNOWLEDGMENT =
  "I understand that Millstadt may contact me to clarify this report and may retain, review, and disclose the submission as described in the Privacy Notice or as otherwise permitted or required by law.";

export const ACCURACY_PRIVACY_NOTICE = [
  "Millstadt collects the information submitted through this voluntary reporting form to evaluate the concern, contact the reporter when clarification is needed, protect document integrity, and maintain a private administrative review record.",
  ...
  "Do not submit patient information, medical records, account credentials, government identification numbers, or other sensitive personal information unless Millstadt specifically requests it through an approved secure process.",
...
export const ACCURACY_REPORT_RESULT =
  "Millstadt received your report. Submission does not establish that the reported material is inaccurate, defamatory, unlawful, or subject to removal. Millstadt may review the cited source, contact you for clarification, and determine whether correction, clarification, republication, or no action is appropriate.";
